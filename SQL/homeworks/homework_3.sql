...
FROM `sql-sandbox-boolean-488922.homework.life-expectancy`
WHERE TRIM(MetricObserved) LIKE "%birth%" AND TRIM(MetricObserved) NOT LIKE "%HALE%"
...
SELECT
    RegionDisplay,
    ROUND(AVG(CASE WHEN MetricObserved NOT LIKE "%60%" AND MetricObserved NOT LIKE "%HALE%" THEN Numeric END), 2) AS LEAB,
    ROUND(AVG(CASE WHEN MetricObserved LIKE "%HALE%" THEN Numeric END), 2) AS HLEAB,
    ROUND(AVG(CASE WHEN MetricObserved LIKE "%60%" THEN Numeric END), 2) AS LE60
FROM `sql-sandbox-boolean-488922.homework.life-expectancy`
GROUP BY RegionDisplay
...
SELECT
    CountryDisplay,
    SUM(beer_servings) AS beer_consumed
FROM `sql-sandbox-boolean-488922.homework.life-expectancy`
...
SELECT
    CountryDisplay,
    SUM(wine_servings) AS wine_consumed
FROM `sql-sandbox-boolean-488922.homework.life-expectancy`
GROUP BY CountryDisplay
ORDER BY wine_consumed DESC
LIMIT 10;

SELECT
    CountryDisplay,
    SUM(spirit_servings) AS spirit_consumed
FROM `sql-sandbox-boolean-488922.homework.life-expectancy`
GROUP BY CountryDisplay
...
SELECT
    CountryDisplay,
    ROUND(AVG(spirit_servings),0) AS avg_spirit_consumed,
    ROUND(AVG(wine_servings),0) AS avg_wine_consumed,
    ROUND(AVG(beer_servings),0) AS avg_beer_consumed,
    AVG(beer_servings) + AVG(wine_servings) + AVG(spirit_servings) AS avg_alcohol_servings
FROM `sql-sandbox-boolean-488922.homework.life-expectancy`
GROUP BY CountryDisplay
...
SELECT CountryDisplay,
       ROUND(AVG(Numeric),2) AS avg_life_expectation_at_birth
FROM `sql-sandbox-boolean-488922.homework.life-expectancy`
WHERE TRIM(RegionDisplay) = "Europe" AND MetricObserved NOT LIKE "%60%" AND MetricObserved NOT LIKE "%HALE%"
GROUP BY CountryDisplay
...
SELECT CountryDisplay,
       ...
       ROUND(AVG(CASE WHEN TRIM(SexDisplay) = "Male" THEN Numeric END),2) AS avg_life_expectation_at_birth_M,
       ROUND(AVG(CASE WHEN TRIM(SexDisplay) = "Female" THEN Numeric END) - AVG(CASE WHEN TRIM(SexDisplay) = "Male" THEN Numeric END),2) AS avg_LE_delta_gender
FROM `sql-sandbox-boolean-488922.homework.life-expectancy`
WHERE MetricObserved NOT LIKE "%60%" AND MetricObserved NOT LIKE "%HALE%"
GROUP BY CountryDisplay
